return @{
    ...
    title="Admin login dialog" #optional: if not given, the folder's name is used
    ...
    # required
    installFn = {
        param($ctx, [string]$user)

        #[System.Windows.Forms.Application]::DoEvents()
        [System.Management.Automation.PSCredential]$creds = Get-Credential -Message "Please enter your username & password" # -UserName $user
        #[System.Windows.Forms.Application]::DoEvents()
